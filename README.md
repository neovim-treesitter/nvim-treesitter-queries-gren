# nvim-treesitter-queries-gren

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gren/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gren/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gren**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gren",
...
- [ ] Changes are scoped to `gren` — do not include files for other languages
